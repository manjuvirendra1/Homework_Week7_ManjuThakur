...
public class Programme14_Person {
    ...
    public void setFirstName(String firstName) {this.firstName = firstName;}//instance method with one param
    public void setLastName(String lastName) {this.lastName = lastName;}//instance method with one param
    public void setAge(int age) { //instance method with one param
        if (age > 0 && age <= 100) {
            this.age = age;
        } else {
            this.age = 0;
